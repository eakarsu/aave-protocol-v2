...
import { notFalsyOrZeroAddress, setDRE, waitForTx } from '../../helpers/misc-utils';
...
//npx hardhat impersonate --mainnetuseraddress 0xE78388b4CE79068e89Bf8aA7f218eF6b9AB0e9d0  --tokenaddress  0x6B175474E89094C44Da98b954EedeAC495271d0F --amount 1000 --localuseraddress 0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266
...
task('impersonate', 'Unlocking mainnet users')
  ...
  .setAction(async ({ mainnetuseraddress, localuseraddress, tokenaddress, amount }, localBRE) => {
    try {
